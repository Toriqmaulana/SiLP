<div class="card-header">
    <a href="<?= base_url('lihatSuratMasukDekan/' . $kelola_disposisi['id']); ?>" class="btn btn-secondary btn-sm">
        <i class="fas fa-fw fa-arrow-left"></i> Kembali
    </a>
</div>

<form class="user" action="<?= base_url('editAksiDisposisiDekan/' . $kelola_disposisi['id']); ?>" method="post">
    <div class="card-body">
        <div class="row">
            <div class="col-lg">
                <div class="p-0">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="isi_disposisi_dekan" autofocus autocomplete="off" value="<?= $kelola_disposisi['isi_disposisi_dekan']; ?>">
                                ...
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input
                                            ...
                                            id="wk<?= $wk['id']; ?>"
                                            value="<?= $wk['id']; ?>"
                                            <?= in_array($wk['id'], explode(',', $kelola_disposisi['pilih_wadek'])) ? 'checked' : ''; ?>>
