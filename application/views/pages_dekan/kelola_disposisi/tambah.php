<div class="card-header">
    <a href="<?= base_url('detailSuratMasukDekan/' . $kelola_disposisi['id']); ?>" class="btn btn-secondary btn-sm">
        <i class="fas fa-fw fa-arrow-left"></i> Kembali
    </a>
</div>

<form class="user" action="<?= base_url('tambahAksiDisposisiDekan/' . $kelola_disposisi['id']); ?>" method="post">
    <div class="card-body">
        <div class="row">
            <div class="col-lg">
                <div class="p-0">
                    ...
                    <div class="form-group">
                        <label for="isi_disposisi_dekan">Isi Disposisi *</label>
                        <input type="text" class="form-control" name="isi_disposisi_dekan" autofocus value="<?= set_value('isi_disposisi_dekan'); ?>" autocomplete="off">
                        <?= form_error('isi_disposisi_dekan'); ?>
                    </div>
                    <div class="form-group">
                        <label for="pilih_wadek">Pilih Wakil Dekan *</label>
                        <div class="row">
                            <?php foreach ($wadek as $wk) : ?>
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input
                                            ...
                                            id="wk<?= $wk['id']; ?>"
                                            value="<?= $wk['id']; ?>"
                                            <?= in_array($wk['id'], is_array(set_value('pilih_wadek')) ? set_value('pilih_wadek') : []) ? 'checked' : ''; ?>>
                                        <label class="form-check-label" for="wk<?= $wk['id']; ?>">
                                            <?= $wk['jabatan']; ?>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <?= form_error('pilih_wadek[]'); ?>
                    </div>
                    <div class="form-group">
                        <input type="hidden" class="form-control" name="diteruskan_kepada_dekan" id="diteruskan_kepada_dekan" value="Dekan">
                    </div>
                </div>
            </div>
        </div>
