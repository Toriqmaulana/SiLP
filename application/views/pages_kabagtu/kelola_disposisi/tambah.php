<div class="card-header">
    <a href="<?= base_url('detailSuratMasukKabagtu/' . $kelola_disposisi['id']); ?>" class="btn btn-secondary btn-sm">
        <i class="fas fa-fw fa-arrow-left"></i> Kembali
    </a>
</div>

<form class="user" action="<?= base_url('tambahAksiDisposisiKabagtu/' . $kelola_disposisi['id']); ?>" method="post">
    <div class="card-body">
        <div class="row">
            <div class="col-lg">
                <div class="p-0">
                    ...
                    <div class="form-group">
                        <label for="isi_disposisi_kabagtu">Isi Disposisi *</label>
                        <input type="text" class="form-control" name="isi_disposisi_kabagtu" autofocus value="<?= set_value('isi_disposisi_kabagtu'); ?>" autocomplete="off">
                        <?= form_error('isi_disposisi_kabagtu'); ?>
                    </div>
                    <div class="form-group">
                        <input type="hidden" class="form-control" name="status" id="status" value="Surat Masih Dicetak Staf">
                    </div>
                    <div class="form-group">
                        <input type="hidden" class="form-control" name="diteruskan_kepada_kabagtu" id="diteruskan_kepada_kabagtu" value="Kabag TU">
                    </div>
                </div>
            </div>
        </div>
