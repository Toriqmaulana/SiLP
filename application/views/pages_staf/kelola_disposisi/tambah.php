...
<form class="user" action="<?= base_url('tambahAksiDisposisiStaf/' . $kelola_sm['id']); ?>" method="post">
    <div class="card-body">
        <div class="row">
            <div class="col-lg">
                <div class="p-0">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="isi_ringkas" autofocus value="<?= set_value('isi_ringkas'); ?>" autocomplete="off">
                        <?= form_error('isi_ringkas'); ?>
                    </div>
                    <div class="form-group">
                        <input type="hidden" class="form-control" name="status" id="status" value="Lembar Disposisi Diteruskan Ke Dekan">
                    </div>
                    <div class="form-group">
                        <input type="hidden" class="form-control" name="buat_disposisi" id="buat_disposisi" value="1">
                    </div>
                </div>
            </div>
        </div>
