...
<form class="user" action="<?= base_url('editAksiDisposisiStaf/' . $kelola_sm['id']); ?>" method="post">
    <div class="card-body">
        <div class="row">
            <div class="col-lg">
                <div class="p-0">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="isi_ringkas" autofocus autocomplete="off" value="<?= $kelola_sm['isi_ringkas']; ?>">
