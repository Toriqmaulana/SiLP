            ...
            <div class="container-fluid">
                ...
                <div class="card o-hidden border-0 shadow-lg my-3">
                    <div class="card-header text-white bg-success">
                        <h3 class="card-title mt-2">Edit Data Surat Pengantar</h3>
                    </div>
                    <!-- /.card-header -->

                    <!-- form start -->
                    <form class="user" action="<?= base_url('editAksiSuratPengantarKaprodi/' . $kelola_sm['id']); ?>" method="post">
                                ...
                                <div class="col-lg">
                                    <div class="px-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="isi_sm" id="mytextarea" autofocus><?= $kelola_sm['isi_sm']; ?></textarea>
                                            <?= form_error('isi_sm'); ?>
                                        </div>
                                        <div class="form-group">
                                            <label for="pilih_kajur">Nama Ketua Jurusan</label>
                                            <select class="form-control" id="pilih_kajur" name="pilih_kajur">
                                                <?php foreach ($kajur as $kr) : ?>
                                                    <?php if ($kr['id'] == $kelola_sm['pilih_kajur']) : ?>
