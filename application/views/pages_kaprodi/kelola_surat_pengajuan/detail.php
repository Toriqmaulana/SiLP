                                        ...
                                        <table>
                                            <tr>
                                                <td colspan="2" align="right">
                                                    Surabaya, <?= format_tanggal_bulan($kelola_pengajuan['tanggal_buat_sm']) ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="15%">Nomor</td>
                                                <td>: <?= $kelola_pengajuan['nomor_sm'] ?></td>
                                            </tr>
                                            <tr>
                                                <td>Perihal</td>
                                                <td>: <?= $kelola_pengajuan['perihal'] ?></td>
                                            </tr>
                                            <tr>
                                                <td>Lampiran</td>
                                                <?php
                                                $berkasFile = $kelola_pengajuan['berkas_file'];
