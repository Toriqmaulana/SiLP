        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card o-hidden border-0 shadow-lg my-3">
                    ...
                    <!-- form start -->
                    <form class="user" action="<?= base_url('tambahAksiSuratPengajuanKaprodi'); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-lg">
                                    <div class="p-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="isi_sm" id="mytextarea"><?= set_value('isi_sm'); ?></textarea>
                                            <?= form_error('isi_sm'); ?>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="hidden" class="form-control" name="status" value="Surat Pengantar Selesai Dibuat Kaprodi">
                                        </div>
                                        <div class="form-group">
                                            <input type="hidden" class="form-control" name="buat_sm" value="1">
                                        </div>
                                    </div>
                                </div>
                            </div>
