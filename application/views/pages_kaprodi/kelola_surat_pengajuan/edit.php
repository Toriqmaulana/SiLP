        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card o-hidden border-0 shadow-lg my-3">
                    ...
                    <!-- form start -->
                    <form class="user" action="<?= base_url('editAksiSuratPengajuanKaprodi/' . $kelola_pengajuan['id']); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg">
                                    <div class="p-4">
                                                    ...
                                                    <?php foreach (explode(',', $kelola_pengajuan['berkas_file']) as $file): ?>
                                                        <div class="file-item">
                                                            ...
                                                            <div class="file-actions">
                                                                ...
                                                                <button type="button" class="btn btn-sm btn-danger" onclick="removeExistingFile('<?= $file ?>', this)" title="Hapus File">
                                        ...
                                        <div class="form-group">
                                            <label for="jenis_surat">Jenis Pengajuan</label>
                                            <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="isi_sm" id="mytextarea"><?= $kelola_pengajuan['isi_sm']; ?></textarea>
                                            <?= form_error('isi_sm'); ?>
                                        </div>
                                        <div class="form-group">
                                            <label for="pilih_kajur">Nama Ketua Jurusan</label>
                                            <select class="form-control" name="pilih_kajur">
                                                <?php foreach ($kajur as $kr) : ?>
                                                    <?php if ($kr['id'] == $kelola_pengajuan['pilih_kajur']) : ?>
                                                        <option value="<?= $kr['id']; ?>" selected><?= $kr['nama']; ?></option>
                                                    <?php else : ?>
        ...
        <script>
            ...
            function removeExistingFile(filename, button) {
                if (confirm('Apakah Anda yakin ingin menghapus file ini?')) {
                    fetch('<?= base_url('removeFileKaprodi/') ?>' + filename, {
                            method: 'POST',
                            headers: {
