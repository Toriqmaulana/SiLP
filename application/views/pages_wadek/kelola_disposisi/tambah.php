<div class="card-header">
    <a href="<?= base_url('detailSuratMasukWadek/' . $kelola_disposisi['id']); ?>" class="btn btn-secondary btn-sm">
        <i class="fas fa-fw fa-arrow-left"></i> Kembali
    </a>
</div>

<form class="user" action="<?= base_url('tambahAksiDisposisiWadek/' . $kelola_disposisi['id']); ?>" method="post">
    <div class="card-body">
        <div class="row">
            <div class="col-lg">
                <div class="p-0">
                    ...
                    <input type="hidden" class="form-control" name="id_wadek" id="id_wadek" value="<?= $user->id; ?>">

                    <div class="form-group">
                        <label for="isi_disposisi_<?= strtolower(str_replace(' ', '', $user->jabatan)); ?>">Isi Disposisi *</label>
                        <input type="text" class="form-control" name="isi_disposisi_<?= strtolower(str_replace(' ', '', $user->jabatan)); ?>" autofocus value="<?= set_value('isi_disposisi_' . strtolower(str_replace(' ', '', $user->jabatan))); ?>" autocomplete="off">
                        <?= form_error('isi_disposisi_' . strtolower(str_replace(' ', '', $user->jabatan))); ?>
                    </div>
                    <div class="form-group">
                        <input type="hidden" class="form-control" name="diteruskan_kepada_<?= strtolower(str_replace(' ', '', $user->jabatan)); ?>" value="<?= $user->jabatan; ?>">
                    </div>
                </div>
            </div>
        </div>
