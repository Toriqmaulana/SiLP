<div class="card-header">
    <a href="<?= base_url('lihatSuratMasukWadek/' . $kelola_disposisi['id']); ?>" class="btn btn-secondary btn-sm">
        <i class="fas fa-fw fa-arrow-left"></i> Kembali
    </a>
</div>

<form class="user" action="<?= base_url('editAksiDisposisiWadek/' . $kelola_disposisi['id']); ?>" method="post">
    <div class="card-body">
        <div class="row">
            <div class="col-lg">
                <div class="p-0">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="isi_disposisi_<?= strtolower(str_replace(' ', '', $user->jabatan)); ?>" autofocus autocomplete="off" value="<?= $kelola_disposisi['isi_disposisi_' . strtolower(str_replace(' ', '', $user->jabatan))]; ?>">
