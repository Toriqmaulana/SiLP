            ...
            <div class="container-fluid">
                ...
                <div class="card o-hidden border-0 shadow-lg my-3">
                    <div class="card-header text-white bg-success">
                        <h3 class="card-title mt-2">Tambah Data Jurusan</h3>
                    </div>
                    <!-- /.card-header -->

                    <!-- form start -->
                    <form class="user" action="<?= base_url('tambahAksiJurusan'); ?>" method="post">
                                ...
                                <div class="col-lg">
                                    <div class="p-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kode_jurusan" id="kode_jurusan" autofocus autocomplete="off" value="<?= set_value('kode_jurusan'); ?>">
                                            <?= form_error('kode_jurusan'); ?>
                                        </div>
                                        <div class="form-group">
                                            <label for="nama_jurusan">Nama Jurusan *</label>
                                            <input type="text" class="form-control" name="nama_jurusan" id="nama_jurusan" autocomplete="off" value="<?= set_value('nama_jurusan'); ?>">
