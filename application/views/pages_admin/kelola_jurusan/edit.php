    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Button -->
                <div>
                    <a href="<?= base_url('jurusan'); ?>" class="btn btn-secondary btn-sm">
                ...
                <div class="card o-hidden border-0 shadow-lg my-3">
                    <div class="card-header text-white bg-success">
                        <h3 class="card-title mt-2">Edit Data Jurusan</h3>
                    </div>
                    <!-- /.card-header -->

                    <!-- form start -->
                    <form class="user" action="<?= base_url('editAksiJurusan/' . $kelola_jurusan['id']); ?>" method="post">
                                ...
                                <div class="col-lg">
                                    <div class="p-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kode_jurusan" id="kode_jurusan" autofocus autocomplete="off" value="<?= $kelola_jurusan['kode_jurusan']; ?>">
                                            <?= form_error('kode_jurusan'); ?>
                                        </div>
                                        <div class="form-group">
                                            <label for="nama_jurusan">Nama Jurusan</label>
                                            <input type="text" class="form-control" name="nama_jurusan" id="nama_jurusan" autocomplete="off" value="<?= $kelola_jurusan['nama_jurusan'] ?>">
