            ...
            <div class="container-fluid">
                ...
                <div class="card o-hidden border-0 shadow-lg my-3">
                    <div class="card-header text-white bg-success">
                        <h3 class="card-title mt-2">Tambah Data Prodi</h3>
                    </div>
                    <!-- /.card-header -->

                    <!-- form start -->
                    <form class="user" action="<?= base_url('tambahAksiProdi'); ?>" method="post">
                                ...
                                <div class="col-lg">
                                    <div class="p-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kode_prodi" id="kode_prodi" autofocus autocomplete="off" value="<?= set_value('kode_prodi'); ?>">
                                            <?= form_error('kode_prodi'); ?>
                                        </div>
                                        <div class="form-group">
                                            <label for="nama_prodi">Nama Prodi *</label>
                                            <input type="text" class="form-control" name="nama_prodi" id="nama_prodi" autocomplete="off" value="<?= set_value('nama_prodi'); ?>">
