    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Button -->
                <div>
                    <a href="<?= base_url('prodi'); ?>" class="btn btn-secondary btn-sm">
                ...
                <div class="card o-hidden border-0 shadow-lg my-3">
                    <div class="card-header text-white bg-success">
                        <h3 class="card-title mt-2">Edit Data Prodi</h3>
                    </div>
                    <!-- /.card-header -->

                    <!-- form start -->
                    <form class="user" action="<?= base_url('editAksiProdi/' . $kelola_prodi['id']); ?>" method="post">
                                ...
                                <div class="col-lg">
                                    <div class="p-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kode_prodi" id="kode_prodi" autofocus autocomplete="off" value="<?= $kelola_prodi['kode_prodi']; ?>">
                                            <?= form_error('kode_prodi'); ?>
                                        </div>
                                        <div class="form-group">
                                            <label for="nama_prodi">Nama Prodi</label>
                                            <input type="text" class="form-control" name="nama_prodi" id="nama_prodi" autocomplete="off" value="<?= $kelola_prodi['nama_prodi'] ?>">
