...
<form class="user" action="<?= base_url('approveSuratMasukKajur/' . $kelola_sm['id']); ?>" method="post">
    <div class="card-body">
        <div class="row">
            <div class="col-lg">
                <div class="p-0">
                                        ...
                                        <div class="footer">
                                            <div class="col-6 text-center">
                                                <p>Mengertahui,<br>
                                                    ...
                                                    <?php else: ?>
                                                        <img src="<?= base_url('assets/'); ?>img/blank.png" alt="Ttd Kosong" height="100"><br>
                                                    <?php endif; ?>
                                                    <?= $nama_kajur ?><br>
                                                    NIP. <?= $nip_kajur ?>
                                                </p>
                    ...
                    <?php if ($kelola_sm['status'] == 'Surat Pengantar Selesai Dibuat Kaprodi') : ?>
                        <div class="form-group">
                            <label for="status">Approved *</label>
                            <select class="form-control" name="status" id="status">
                                <option value="">- Pilih Approved -</option>
                                <option value="Disetujui Kajur">Disetujui</option>
                                <option value="Ditolak Kajur">Ditolak</option>
                            </select>
                            <?= form_error('status'); ?>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if ($kelola_sm['status'] == 'Ditolak Kajur') : ?>
                        <div class="form-group">
                            <label for="alasan_kajur">Alasan Ditolak</label>
                            <input type="text" class="form-control text-danger" name="alasan_kajur" value="<?= $kelola_sm['alasan_kajur']; ?>" readonly>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
