...
$route['Dosen'] = 'Dosen';
$route['pengajuan'] = 'Dosen/pengajuan';
$route['tambahPengajuan'] = 'Dosen/tambahPengajuan';
$route['tambahAksiPengajuan'] = 'Dosen/tambahAksiPengajuan';
$route['editPengajuan/(:num)'] = 'Dosen/editPengajuan/$1';
$route['editAksiPengajuan/(:num)'] = 'Dosen/editAksiPengajuan/$1';
$route['removeFile/(:any)'] = 'Dosen/removeFile/$1';
$route['detailPengajuan/(:num)'] = 'Dosen/detailPengajuan/$1';
$route['hapusPengajuan/(:num)'] = 'Dosen/hapusPengajuan/$1';
$route['arsip'] = 'Dosen/arsip';
$route['profile'] = 'Dosen/profile';
$route['editProfile/(:num)'] = 'Dosen/editProfile/$1';
